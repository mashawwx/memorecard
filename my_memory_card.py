...
questions_list = []
questions_list.append(Question('Какая самая большая страна в мире?','Россия','Канада','Китай','США'))
questions_list.append(Question('Какое слово значит дерево?','tree','orange','house','friend'))
questions_list.append(Question('Сколько будет 48 + 7?','55','65','54','60'))
questions_list.append(Question('Национальный язык Германии?','немецкий','английский','русский','арабский'))
questions_list.append(Question('Что из этого ягода?','арбуз','яблоко','груша','апельсин'))
questions_list.append(Question('Язык программирования, на котором написан этот код','Python','JavaScript','С++','Swift'))
questions_list.append(Question('Сколько будет 2 + 2?','4','5','3','8'))
questions_list.append(Question('Какое сейчас время года?','осень','зима','лето','весна'))
questions_list.append(Question('В честь кого будет 2022 год?','тигр','крыса','кролик','бык'))
questions_list.append(Question('Что из этого фрукт?','яблоко','огурец','свёкла','картошка'))
 
app = QApplication([])
 
btn_OK = QPushButton('Ответить') # кнопка ответа
button = QPushButton("Выход")  # кнопка выход
...
window.setWindowTitle('Memo Card')# по-хорошему такие переменные должны быть свойствами, 
